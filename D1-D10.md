...
I have no idea why, but my users insist on reporting problems on Fridays after I've gone home even though they were aware of the problem days ago. This means that my weekends
are also somewhat semi-stressful. Such is the case today. I received no less than 5 reports in my email *after* my day was complete. Today, I'm feeling irritated before coding.

### What I Did

I have a personal project that I use for work purposes written in JavaScript. Because I will need it in the next few days I spent some time refactoring and refining it. It is run in the browser so CSS and HTML also come into play here.

### After Coding

Feeling good that I did this even if I'm the only one who will ever see this project. Also, it has the added benefit of making my job a bit less stressful a few days from now.